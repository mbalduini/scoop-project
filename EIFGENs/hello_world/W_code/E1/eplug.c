/*
 * Generated by ISE 15.12.9.8497 GPL Edition - linux-x86-64
 */
...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F299_3500;
	egc_strset = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F221_6333;
	egc_str32set = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F227_6541;
	egc_routdisp_wb = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F248_6061;
	...
	egc_sp_bool = 0x019E;
	egc_sp_uint8 = 0x021C;
	egc_sp_uint16 = 0x025F;
	egc_sp_uint32 = 0x01EB;
	egc_sp_uint64 = 0x0167;
	egc_sp_int8 = 0x02B6;
	egc_sp_int16 = 0x02D3;
	egc_sp_int32 = 0x01BB;
	egc_sp_int64 = 0x02F0;
	egc_sp_real32 = 0x0299;
	egc_sp_real64 = 0x027C;
	egc_sp_pointer = 0x01F2;
	egc_sp_ref = 0x0129;
	...
	egc_system_name = "hello_world";
	egc_system_location = "/home/affo/hello_world/EIFGENs/hello_world/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1457430370;
